//xz-notify.min.js,3.0.3,https://github.com/dknight/xz-notify
"use strict";const t=class extends HTMLElement{constructor(i,e,o=!1,s=t.defaults.GROUPED,a=t.positions.NE,n=t.defaults.EXPIRE,l=t.defaults.TYPE,h=!0,c){super(),this.root=i,this.styleElem=e,this.forcedClose=o,this.grouped=s,this.position=a,this.expire=n,this.type=l,this.closeable=h,this.heading=c,this.root=this.attachShadow({mode:"open"}),this.styleElem=document.createElement("style"),this.styleElem.textContent=`:host {
